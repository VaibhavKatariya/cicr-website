            ...
            <div>
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-2 bg-bg-light border border-gray-300 dark:border-gray-700 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-orange-600"
